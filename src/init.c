...
extern SEXP write_png_(SEXP image_ , SEXP file_, SEXP palette_, SEXP use_filter_, SEXP compression_level_, SEXP avoid_transpose_, SEXP bits_, SEXP trns_);
extern SEXP get_png_info_(SEXP src_);


static const R_CallMethodDef CEntries[] = {
  {"read_png_"   , (DL_FUNC) &read_png_ , 5},
  {"write_png_"  , (DL_FUNC) &write_png_, 8},
